...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::Pulse*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("Pulse", ::Pulse::Class_Version(), "DecLibTest.hh", 139,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::Event*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("Event", ::Event::Class_Version(), "DecLibTest.hh", 151,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::DecFile*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("DecFile", ::DecFile::Class_Version(), "DecLibTest.hh", 168,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::DecManager*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("DecManager", ::DecManager::Class_Version(), "DecLibTest.hh", 200,
